...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	if is_gbanned(msg.from.id) then
        return '<i>✨شما گولبال بن هستید✨.\n ✨برای ازاد کردن خود به @TT_Antispam یا آیدی @amirtabrizli1 مراجعه کنید✨</i>'
	end
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = " <i>✨خوش آمدید✨!\n\n>برای دریافت گروه یا مدیریت گروه شما  یا آیدی @AmirTabrizli1 مراجعه کنید! یا بایکی از مدیران در تماس باشید, برای اینکار کانال را چک کنید:\n[@TT_AntiSpam] \n\nبااستفاده از دستور 'راهنما' لیست دستورات را دریافت کنید!!\n\n✨باتشکر از انتخاب @TT_AntiSpam✨ </i>"
     	return text
    end
